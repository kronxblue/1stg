<html>
    <body style="padding: 0px; margin: 0px; font-family: 'Verdana'; color: #666; max-width: 960px;">
        ...
        <div style="font-size: 14px; display: block; min-height: 200px; margin: 10px auto 0px; background-color: #fff; padding: 20px;">
            <p><b>Hai Admin,</b></p>
            <p>You have received new payment. Below is the payment details for you to verify :</p>
            <br/>
            <hr style="border: 1px dashed #ccc;"/>
            <br/>
            <p>
                <b>Agent Fullname : </b> [FULLNAME]
                <br/>
                <b>Agent ID : </b> [AGENT_ID]
                <br/>
                <br/>
                <b>Subject : </b> [PAYMENT_FOR]
                <br/>
                <b>Payment Date/Time. : </b> [DATE_TIME]
                <br/>
                <br/>
                <b>From Acc. :</b> [FROM_ACC]
                <br/>
                <b>To Acc. :</b> [TO_ACC]
                <br/>
                <b>Payment Method :</b> [PAYMENT_TYPE]
                <br/>
                <b>Reference No. :</b> [REF]
                <br/>
                <br/>
                <b>Amount :</b> [AMOUNT]
            </p>
            ...
            <p style="color: red; font-size: 12px;">
                <b>Note :</b> Please log in to admin backoffice to verify this payment.
            </p>
            <br/>
            <br/>
            <p>
