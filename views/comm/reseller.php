...
<div class="col-xs-12">
    <h2 class="page-header">
        Reseller Commission <a class="btn btn-primary btn-sm pull-right" href="<?php echo BASE_PATH; ?>comm">Back to Summary</a>
        <input type="hidden" id="type" name="type" value="Reseller" />
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7 col-md-6">
                        <select class="form-control" id="f" name="f" data-url="<?php echo BASE_PATH; ?>comm/reseller">
    ...
    <br/>
    <div class="col-xs-12">
        <div id="resellerCommission" data-url="<?php echo BASE_PATH; ?>comm/getCommissionStatement" class="table-responsive">
